...
Our analysis explicitly quantifies the inflation caused by naive evaluation schemes: subject-level accuracy was notably lower than recording-level accuracy, demonstrating the ``hidden cost'' of methodological rigor that many studies fail to report. Feature importance analysis revealed frontal channels as top predictors, providing biological rationale consistent with well-documented prefrontal abnormalities in schizophrenia and informing a proof-of-concept low-cost hardware design.
